...
<nav class="top-bar">
   <div class="top-bar-left" id="gnb">
    ...
    <div class="orbit" role="region" aria-label="Favorite Space Pictures" data-orbit>
      <ul class="orbit-container" style="width: 50%; height: auto; margin: auto; margin-top: 50px;">
        <button class="orbit-previous" aria-label="previous"><span class="show-for-sr">Previous Slide</span>&#9664;</button>
        <button class="orbit-next" aria-label="next"><span class="show-for-sr">Next Slide</span>&#9654;</button>
        <li class="orbit-slide is-active">
          <img src="./resources/icon/main11.jpg" alt="더미이미지">
        </li>
        <li class="orbit-slide">
          <img src="./resources/icon/main12.jpg" alt="더미이미지">
        </li>
        <li class="orbit-slide">
          <img src="./resources/icon/main13.jpg" alt="더미이미지">
        </li>
        <li class="orbit-slide">
          <img src="./resources/icon/main14.jpg" alt="더미이미지">
        </li>
        <li class="orbit-slide">
          <img src="./resources/icon/main15.jpg" alt="더미이미지">
        </li>
      </ul>
    </div>